...
def index(request): 
    API_KEY = open("C:\\Django Project\\weather_project\\API_KEY", "r").read()
...
def fetch_weather_and_forecast(city, api_key, current_weather_url, forecast_url):
    ...
    weather_data = {
        ...
        "descprition": response['weather'][0]['description'],
    ...
    for daily_data in forecast_response['daily'][:5]:
        daily_forecasts.append({    
                ...
                "min_temp": round(daily_data['temp']['min'] - 217.15, 2),
                "max_temp": round(daily_data['temp']['max'] - 217.15, 2),
